...
A simple JavaScript library providing various mathematical utility functions.
...
Final update to trigger fresh check runs for all check suites (2025-08-17 15:50).
